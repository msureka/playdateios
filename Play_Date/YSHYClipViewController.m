...
-(void)CreatUI
{
    ...
    if ([[defaults valueForKey:@"CheckedView"]isEqualToString:@"yes"])
    {
        View1=[[UIView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 64)];
        
        UIButton * BackButton = [UIButton buttonWithType:UIButtonTypeRoundedRect];
        BackButton.titleLabel.font=[UIFont fontWithName:@"Helvetica" size:16.0f];
        [BackButton setTitleColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.9] forState:UIControlStateNormal];
        [BackButton setTitle:@"" forState:UIControlStateNormal];
        [BackButton addTarget:self action:@selector(backBtnClicked:) forControlEvents:UIControlEventTouchUpInside];
        [BackButton setBackgroundColor:[UIColor clearColor]];
        [BackButton setFrame:CGRectMake(self.view.frame.size.width-60, 25,50, 50)];
        
        [BackButton setBackgroundImage:[UIImage imageNamed:@"Cancel.png"] forState:UIControlStateNormal];
    ...
    clipBtn.titleLabel.font=[UIFont fontWithName:@"KG Feeling 22" size:32.0f];
    [clipBtn setTitle:@"Save picture!" forState:UIControlStateNormal];
    [clipBtn setTitleColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.9] forState:UIControlStateNormal];
    [clipBtn addTarget:self action:@selector(clipBtnSelected:) forControlEvents:UIControlEventTouchUpInside];
    [clipBtn setBackgroundColor:[UIColor colorWithRed:255/255.0 green:244/255.0 blue:96/255.0 alpha:1]];
    [clipBtn setFrame:CGRectMake(0, self.view.frame.size.height - 54, self.view.frame.size.width, 54)];
//    CALayer *borderTop = [CALayer layer];
//    borderTop.backgroundColor = [UIColor lightGrayColor].CGColor;
//    
//    borderTop.frame = CGRectMake(0, 0, clipBtn.frame.size.width, 1);
//    [clipBtn.layer addSublayer:borderTop];
    
    [self.view addSubview:clipBtn];
    

    UILabel *fromLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.view.frame.size.height - 165 , self.view.frame.size.width-40, 50)];
    fromLabel.text = @"Move, zoom and fit your picture in the above circle";
    fromLabel.textColor=[UIColor colorWithRed:0 green:0 blue:0 alpha:0.9] ;
    fromLabel.font = [UIFont fontWithName:@"Helvetica" size:18]; //custom font
...
-(void)backBtnClicked:(UIButton*)sender
{
    ...
    [self.delegate ClipViewController1:self];
