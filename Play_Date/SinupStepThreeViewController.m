...
- (void)viewDidLoad {
    ...
    if (self.view.frame.size.width==375.00 && self.view.frame.size.height==812.00)
    {
        ...
        [IndoorButton_Label setFrame:CGRectMake(IndoorButton_Label.frame.origin.x, IndoorButton_Label.frame.origin.y-18, IndoorButton_Label.frame.size.width, IndoorButton_Label.frame.size.height)];
        
        [EveryWhereButton_Label setFrame:CGRectMake(EveryWhereButton_Label.frame.origin.x, EveryWhereButton_Label.frame.origin.y-9, EveryWhereButton_Label.frame.size.width, EveryWhereButton_Label.frame.size.height)];
    }
